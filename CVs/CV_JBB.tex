...
1996--present, Senior Staff Scientist,  LBNL \\ 
1996--2014, Group Lead, CCSE, LBNL \\ 
1993--1996, Director of the Center for Computational Sciences and Engineering, LLNL \\ 
1986--1993, Staff Scientist, LLNL \\ 
...
A. Almgren (LBNL) \\ A. Aspden (Southhampton) \\ V. Beckner (LBNL) \\ 
A. Burrows (Princeton) \\ C. Chan (LBNL) \\ J. Chen (SNL) \\ 
R. Cheng (LBNL) \\ M. Day (LBNL) \\ A. Donev (CIMS) \\ M. Duarte (LBNL) \\ 
A. Garcia (SJSU) \\  E. Hawke (Univ. of NSW) \\ J. Goodman (NYU) \\ R. Grout (NREL) \\
D. Kasen (UCSC) \\ C. Law (Princeton) \\ 
Z. Lukic (LBNL) \\
