...
%\usepackage[pagestyles,raggedright]{titlesec} % related with sectionsâ€”n
...
The CCSNe simulations will utilize \chimera\
 to attack the decades-old computational challenge of simulating these stellar explosions. We will perform well-resolved, symmetry-free, three-dimensional (3D) simulations with sufficient physical detail required to understand these complex stellar explosions and their observable products.These simulations will cover the lower end of the range of massive stars, from oxygen-neon-core stars on the lightest end (about nine solar masses), up to the 
 least massive iron-core stars ($\sim$12 solar masses).
 \chimera\  contains all of the relevant physics required for core-collapse supernova simulations including transport of energy by 
 neutrinos and the required neutrinoÐmatter interactions, general relativity and self-gravity, nuclear burning and nuclear equations of state, and three-dimensional fluid dynamics. \chimera\
 has been developed and used in INCITE projects on OLCF resources for much of the last decade. 
